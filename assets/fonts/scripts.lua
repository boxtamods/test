...
function onUpdate(elapsed)
    ...
    if curStep >= 704 and curStep < 831 then
        for i = 0,7 do --the amount of notes like 0,7 is all, 0.3 is all opponent and 4,7 is all player. to do single just 0,0
            setPropertyFromGroup('strumLineNotes', i, 'x', defaultNotePos[i + 1][1] + move * math.cos((currentBeat + i*1) * math.pi))
            setPropertyFromGroup('strumLineNotes', i, 'y', defaultNotePos[i + 1][2] + move * math.sin((currentBeat + i*3) * math.pi))
